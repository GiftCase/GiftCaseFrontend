var app = {
  ...
  successHandler: function(result) {
    ...
    if (app.deviceId !== null && app.deviceId !== undefined)
    {
      //alert("successHandler push notification receive id");
    ...
    switch( e.event )
    {
        case 'registered':
            if ( e.regid.length > 0 )
            {
              ...
              //alert("onNotificationGCM registered sent");
              if (!app.notificationSent)
              {
                //alert("onNotificationGCM push notification receive id");
